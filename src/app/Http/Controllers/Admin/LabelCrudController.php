...
use SequelONE\SongsCRUD\app\Http\Requests\LabelRequest;
...
class LabelCrudController extends CrudController
{
    ...
    {
        $this->crud->setModel("SequelONE\SongsCRUD\app\Models\Label");
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin').'/songs/labels');
